  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      <div className="w-full lg:w-9/12 p-4">
        <h1 className="text-2xl font-bold text-left uppercase mb-10 animate__animated animate__fadeIn">
          Giới thiệu
        </h1>
        <h1
          className="text-3xl text-center uppercase animate__animated animate__fadeIn"
          style={{ color: "#a17410", fontWeight: "900" }}
        >
          Hàn Ngữ Munan
        </h1>
        <img
        ...
        <img
          ...
          className="my-4 mx-auto animate__animated animate__fadeIn"
        />
        <h2 className="text-xl font-bold mt-8 animate__animated animate__fadeIn">
          Chương trình học tiếng Hàn gồm:
        </h2>
        <ul className="list-disc list-inside mt-4 font-bold animate__animated animate__fadeIn">
        ...
        <h2 className="text-xl font-bold mt-8 animate__animated animate__fadeIn">Học tiếng Hàn để làm gì?</h2>
        <h3 className="text-lg font-semibold mt-4 animate__animated animate__fadeIn">
        ...
        <h3 className="text-lg font-semibold mt-4 animate__animated animate__fadeIn">2. Giáo viên tiếng Hàn</h3>
        <p className="mt-2 animate__animated animate__fadeIn">
        ...
        <div className="mt-8 animate__animated animate__fadeIn">
          <h2 className="text-xl font-bold">Chia sẻ bài viết này:</h2>
      ...
      <div className="w-full lg:w-3/12 p-4">
        ...
        <div className="border p-4 mt-4 animate__animated animate__fadeIn">
          <h2 className="text-xl font-bold mb-4">TIN CHO BẠN</h2>
          <div className="flex items-center mb-4 animate__animated animate__fadeIn hover:animate__pulse">
            ...
            />
            <div>
              <h3 className="text-lg font-semibold">Tiêu đề tin tức 1</h3>
          ...
          <div className="flex items-center mb-4 animate__animated animate__fadeIn hover:animate__pulse">
            ...
            />
            <div>
              <h3 className="text-lg font-semibold">Tiêu đề tin tức 2</h3>
              <p className="text-sm text-gray-600 flex items-center">
                <FaCalendarAlt className="mr-1" /> 13/03/2025
              </p>
            </div>
          ...
          <div className="flex items-center mb-4 animate__animated animate__fadeIn hover:animate__pulse">
            ...
            />
            <div>
              <h3 className="text-lg font-semibold">Tiêu đề tin tức 3</h3>
              <p className="text-sm text-gray-600 flex items-center">
                <FaCalendarAlt className="mr-1" /> 13/03/2025
              </p>
            </div>
